...
class App extends React.PureComponent {
    ...
    render() {
        ...
        const shufflePhotos = () => {
            this.setState({
                "json": shuffleOrder(0, images), "vals": vals
            })
        }
        ...
        return (
            <View className="App" style={{display: "flex"}}>
                ...
                <View style={{position: "relative", top: 50}}><Button onPress={shufflePhotos}
                                                                      title='Shuffle Photos'></Button></View>
            </View>
        );
    }
}
